...
<main>
    ...
    <div
        ...
        <div class="breadcrumb__background"
            data-background="assets/imgs/breadcrumb/azo-organic-pigments-paint-coating.jpg"></div>
        <div class="container">
                    ...
                    <div class="blog-details__content">
                        ...
                        <div class="row">
                            <div class="col-xl-6 blog-details__media">
                                <img src="assets/imgs/azo-organic-pigments-paint-coating/azo-organic-pigments-paint-coating-1.jpg"
                                    alt="image not found">
                            </div>
                            <div class="col-xl-6 blog-details__media">
                                <img src="assets/imgs/azo-organic-pigments-paint-coating/azo-organic-pigments-paint-coating-2.jpg"
                                    alt="image not found">
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="what-we-do__wrapper">
                ...
                <div class="row">
                    <div class="col-xl-4 has--border has--border-1">
                        <div class="what-we-do__item has--padding-pb">
                            <div class="what-we-do__item-icon">
                                <a href="pigment-yellow-1.php">
                                    <div class="why-choose-us-2__icon" style="background-color:yellow;"></div>
                                </a>
                            </div>
                            <div class="text">
                                <a href="pigment-yellow-1.php"><span class="section__subtitle color-black">Pigment
                                        Yellow-1</span></a>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar</p>
                    ...
                    <div class="col-xl-4 has--border has--border-1">
                        <div class="what-we-do__item has--padding-ptb">
                            <div class="what-we-do__item-icon">
                                <a href="pigment-yellow-1.php">
                                    <div class="why-choose-us-2__icon" style="background-color:yellow;"></div>
                                </a>
