...
// Fetch all images for this sub-category
$imgStmt = $pdo->prepare("
...
// Primary image for breadcrumb bg
...
// Border class cycling for product grid
...
<main>
    ...
    <!-- Sub-category detail area start -->
    ...
    <!-- Sub-category detail area end -->

    <!-- Products grid area start -->
                            ...
                            <div class="col-xl-4 has--border <?php echo $borderClass; ?>">
                                <div class="what-we-do__item <?php echo $paddingClass; ?>">
                                    ...
                                    <div class="text">
                                        <a href="<?php echo $productLink; ?>">
                                            <span
                                                class="section__subtitle color-black"><?php echo htmlspecialchars($productName); ?></span>
                                        </a>
                                        <?php if (!empty($product['color_name'])): ?>
                                            <p class="what-we-do__item-desc"><?php echo htmlspecialchars($product['color_name']); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
