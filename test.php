                                ...
                                <span>
                                    <svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke-linejoin="round" />
                                        <path d="M5.4541 1V10.8" stroke="#906E50" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                                ...
                                                <li>
                                                    <div class="home__menu-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="#">High Performance Chrome Inorganic
                                                                    Pigments</a></li>
                                ...
                                <div class="header__btn-wrap align-items-center d-inline-flex">
                                    ...
                                    <a href="contact-us.html" class="rr-header-message d-none d-sm-flex">
                                        <svg width="15" height="16" viewBox="0 0 15 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M13.4444 15.0002V13.4446C13.4444 12.6195 13.1167 11.8282 12.5332 11.2447C11.9498 10.6613 11.1585 10.3335 10.3333 10.3335H4.11111C3.28599 10.3335 2.49467 10.6613 1.91122 11.2447C1.32778 11.8282 1 12.6195 1 13.4446V15.0002"
                                                stroke="#767676" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M7.22244 7.22222C8.94066 7.22222 10.3336 5.82933 10.3336 4.11111C10.3336 2.39289 8.94066 1 7.22244 1C5.50422 1 4.11133 2.39289 4.11133 4.11111C4.11133 5.82933 5.50422 7.22222 7.22244 7.22222Z"
                                                stroke="#767676" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                ...
                                <div class="banner-2__content">
                                    ...
                                    <h6 class="banner-2__content-subtitle">
                                        ...
                                        <svg width="40" height="19" viewBox="0 0 40 19" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M29 13L34 18L39 13" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M0.75 0H0V1.5H0.75H33.25V16.75C33.25 17.1642 33.5858 17.5 34 17.5C34.4142 17.5 34.75 17.1642 34.75 16.75V0.75V0H34.5H33.75H33.25H0.75Z"
                                                fill="white" />
                                        </svg>
                                    </h6>
                                    <h1 class="banner-2__content-title">Architecture With People in Mind.</h1>
                                    <p class="description mb-0">Take your business to the next level with Breeza
                                        Business agency for business Idea management tools for you</p>
                                    ...
                                    <div class="banner-2__btn-box mt-40">
                                        ...
                                        <div class="banner-2__btn-box-wrapper">
                                            <a href="https://www.youtube.com/watch?v=vkew-1KK3Sc" class="popup-video"
                    ...
                    <div class="col-lg-6">
                        <div class="about-company__content">
                            ...
                            <div class="section__title-wrapper mb-50 mb-xs-35">
                                ...
                                <h2 class="section__title mb-25">Creating Inspiring Spaces Discover Premier Interior
                                    Design Experts</h2>
                                <p class="mb-0">System is a term used to refer to an organized collection symbols and
                                    processes that may be used to operate on such symbols. Perspiciatis omnis natus
                                    error voupems accusa organized.</p>
                            </div>
        ...
        <section class="text-slider text-slider__section-space overflow-hidden">
            <div class="text-slider__slider carouselTicker carouselTicker-nav">
                <ul class="carouselTicker__list">
                    <li>
                        <h2 data-text="ARCHITECTURE" class="title">ARCHITECTURE</h2>
                    </li>
                    <li><img src="assets/imgs/text-slider/star.png" alt="image not found"></li>
                    <li>
                        <h2 data-text="INTORIOR" class="title">INTORIOR</h2>
                    </li>
                    <li><img src="assets/imgs/text-slider/star.png" alt="image not found"></li>
                    <li>
                        <h2 data-text="CONSTRUCTION" class="title">CONSTRUCTION</h2>
                    </li>
                    <li><img src="assets/imgs/text-slider/star.png" alt="image not found"></li>
                    <li>
                        <h2 data-text="ARCHITECTURE" class="title">ARCHITECTURE</h2>
                        ...
                        <div class="swiper-slide">
                            <div class="expert__item wow clip-a-z">
                                ...
                                <div class="expert__text">
                                    ...
                                    <p>Quis blandit turpis cursus in hac habitasse platea dictumst quisque. Vivamus at
                                        augue sit amet justo eget arcu dictum varius duis.</p>

                                    <a href="service-details.html" class="expert__arrow">
                                        <svg width="28" height="29" viewBox="0 0 28 29" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.53516 22.5654L22.2532 5.98584" stroke="#767676"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M14.0869 4.97693H23.0522V13.9422" stroke="#767676"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                </div>
                ...
                <div class="row mb-60 mb-md-100 mb-sm-100 mb-xs-80 justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="recent-project__slider__arrow d-flex justify-content-lg-end justify-content-start">
                            <button
                                class="recent-project__slider__arrow-prev d-flex align-items-center justify-content-center">
                                <svg width="10" height="18" viewBox="0 0 10 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 1L1 9L9 17" stroke="#080A0B" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            ...
                            <button
                                class="recent-project__slider__arrow-next d-flex align-items-center justify-content-center">
                                <svg width="10" height="18" viewBox="0 0 10 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L9 9L1 17" stroke="#080A0B" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </button>
                        </div>
                                ...
                                <div class="recent-project__media">
                                    ...
                                    <a href="protfolio-details.html" class="recent-project__arrow">
                                        <svg width="22" height="20" viewBox="0 0 22 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.50684 18.5306L20.2812 2.01485" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.1182 0.978088L21.0834 1.0086L21.0529 9.97384" stroke="white"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="why-choose-us-2__media ">
                            <img class="wow clip-a-z" src="assets/imgs/why-choose-us-2/why-choose-us.png"
                                alt="image not found">
                        </div>
                    </div>
                        ...
                        <div class="why-choose-us-2__content ">
                            ...
                            <div class="why-choose-us-2__item">
                                ...
                                <div class="why-choose-us-2__text">
                                    ...
                                    <p class="mb-0">Placerat condimentum mattis odio donec lacus porta torq uent, mauris
                                        gravida rutrum Fusce.</p>
                                </div>
                            </div>
                            <div class="why-choose-us-2__item">
                                <div class="why-choose-us-2__icon">
                    ...
                    <div class="col-lg-6">
                        <div class="clients-testimonial__content">
                            <div class="section__title-wrapper mb-45 mb-xs-35">
                                ...
                                <h2 class="section__title mb-30 title-animation">We Provide Quality The Best Services
                                </h2>
                                <p class="mb-0">Lorem Ipsum is simply dummy a of the printing and type setting industry
                                    Loreaim Ipsum has been</p>
                            </div>
                            ...
                            <div class="clients-testimonial__content-wrapper">
                                <div class="clients-testimonial__content-icon">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        ...
                                        <path
                                            d="M19.9533 1.93562C11.5043 1.93562 4.22642 7.7666 2.33436 15.9002L1.10898 13.8621L0 14.526L2.27293 18.3047L6.06029 16.0369L5.3949 14.9305L3.64251 15.9795C5.47508 8.53885 12.1814 3.22595 19.9533 3.22595C21.652 3.22595 23.3281 3.47756 24.935 3.97433L25.3178 2.74207C23.5868 2.20659 21.782 1.93562 19.9533 1.93562Z"
                                            fill="#906E50" />
                                        <path
                                            d="M39.6856 14.2852L35.8983 12.0174L33.626 15.7968L34.735 16.4607L35.8666 14.5787C36.4621 16.3174 36.7667 18.1362 36.7667 20C36.7667 23.8368 35.4346 27.5878 33.0169 30.5613L34.0211 31.3742C36.6257 28.1716 38.06 24.1316 38.06 20C38.06 18.0265 37.7412 16.0994 37.1198 14.2542L39.0202 15.3916L39.6856 14.2852Z"
                                            fill="#906E50" />
                                    </svg>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="clients-testimonial__item">
                                            ...
                                            <div class="clients-testimonial__author-media">
                                                <img src="assets/imgs/clients-testimonial/author.png"
                                                    alt="image no found">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="clients-testimonial__slider__arrow">
                                <button class="clients-testimonial__slider__arrow-prev">
                                    <svg width="8" height="14" viewBox="0 0 8 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 13L1 7L7 1" stroke="#080A0B" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </button>
                                <button class="clients-testimonial__slider__arrow-next">
                                    <svg width="8" height="14" viewBox="0 0 8 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 13L7 7L1 1" stroke="#080A0B" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </button>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div
                            class="experience-2__box d-flex flex-wrap justify-content-sm-around justify-content-center">
                            <div class="experience-2__item d-flex flex-wrap align-items-center">
                                <div class="experience-2__item-text">
                                    <h2 class="experience-2__item-text-title "><span class="odometer"
                        ...
                        <div class="blog-2__item">
                            ...
                            <div class="blog-2__content">
                                <ul class="blog-2__meta-list">
                                    <li> <svg width="15" height="16" viewBox="0 0 15 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                stroke="#767676" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M10.3887 1V3.8" stroke="#767676" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M4.61133 1V3.8" stroke="#767676" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M1 6.6001H14" stroke="#767676" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        26 January,2024
                                    </li>
                                ...
                                <h6 class="blog-2__title"><a href="blog-details.html">Is Architecture a Good Careerin
                                        Our Daily
                                        Life?</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="footer-2__widget footer-2__widget-item-1">
                                ...
                                <div class="footer-2__content mb-30 mb-xs-35">
                                    <p class="mb-0">Leo site ultrices donec a volutpat penatibus mind suscipit faucibus
                                        and duis pharetra name sociosqu phasellus nunce accumsan</p>
                                </div>
                ...
                <div class="container">
                    <div class="footer-2__bottom-wrapper">
                        <div class="footer-2__copyright text-lg-start text-center">
                            <p class="mb-0">Copyright © 2024 by <a href="index.html">RRDevs.</a> All Rights Reserved.
                            </p>
                        </div>
